...
The Dash app reads `SQL/USDA_production_2023.csv`, which can be regenerated by
[`SQL/07_dashboard_export.sql`](../SQL/07_dashboard_export.sql). The export
uses annualized production totals with these rules:
